...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：常住人员管理&nbsp;&nbsp;>&nbsp;&nbsp;新增常住人员</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="addlocal.php" target="mainFrame" onFocus="this.blur()" class="add">新增常住人员</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="pushaddlocal.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">启用标识：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
		<input type="radio" name="USERFLAG" value="1" checked='checked'>启用</br>
		<input type="radio" name="USERFLAG" value="0">未启用</br>
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">人脸名称：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="FACENAME" value="" class="text-word">*
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
