...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：进出记录查询</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table id="babyTable" width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">人员身份</th>
        <th align="center" valign="middle" class="borderright">设备号</th>
        <th align="center" valign="middle" class="borderright">身份证号</th>
        <th align="center" valign="middle" class="borderright">联系方式</th>
        <th align="center" valign="middle" class="borderright">记录时间</th>
...
function sendDel(id){
	var con;
	con = confirm("确认删除ID为"+id+"的记录么？");//弹出确认对话框
