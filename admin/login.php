...
<div class="tyg-div">
	<ul>
    	<li>让</li>
    	<li><div style="margin-left:20px;">科</div></li>
    	<li><div style="margin-left:40px;">技</div></li>
...
<div id="contPar" class="contPar">
	<div id="page1"  style="z-index:1;">
		<div class="title0">小区人员进出管理系统</div>
		<div class="title1">西船小区管理后台</div>
		<div class="imgGroug">
			<ul>
...
<div class="tyg-div-denglv">
	<div class="tyg-div-form">
		<form action="index.php" method="post">
			<h2>登录</h2><p class="tyg-p">欢迎访问  后台管理</p>
			...
			<div style="margin:5px 0px;">
				<input type="text" style="width:150px;" placeholder="请输入验证码..." name="authcode"/>
				<a href="javascript:void(0)" onclick="document.getElementById('captcha_img').src='./captcha.php?r='+Math.random() ">
				<img  id="captcha_img" border="1" src="./captcha.php?r=<?php echo rand(); ?>" style="vertical-align:bottom;">
				</a>
