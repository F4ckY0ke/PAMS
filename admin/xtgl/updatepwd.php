...
$sql = "SELECT USER,PASSWORD,MODE,TEL,NAME,IDCARD FROM U_ADMIN where USER='{$adminid}';";
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：管理员账号&nbsp;&nbsp;>&nbsp;&nbsp;更改个人信息</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">更改个人信息</a>
    </td>
  </tr>
  <tr>
...
*
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <select name="MODE" id="level" value="3" disabled="disabled">
