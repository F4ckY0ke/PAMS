...
function sendDel(id){
	var con;
	con = confirm("确认删除"+id+"管理员么？");//弹出确认对话框
	if(con==true){//单击确认按钮布尔变量为true
		window.location.href = "deladmin.php?id="+id+"";
	}
	else window.location.href = "main_list.php";//单击取消按钮刷新页面

}

function sendUpdate(id){
	window.location.href = "updateadmin.php?id="+id+"";//点击修改按钮将按钮所在行的id以get参数发送给更新页面
}
</script>
</body>
</html>